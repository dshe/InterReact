...
namespace InterReact
{
    public partial class Services
    {
        ...
        /// </summary>
        public IObservable<Union<MarketDepth, Alert>> CreateMarketDepthObservable(Contract contract, int rows = 3, bool isSmart = false, IEnumerable<Tag>? options = null)
        {
            if (rows < 1)
            ...
            return Response.ToObservableContinuousWithId(
                    Request.GetNextId,
                    id => Request.RequestMarketDepth(id, contract, rows, isSmart, options),
