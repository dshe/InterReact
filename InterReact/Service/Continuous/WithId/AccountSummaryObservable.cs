...
namespace InterReact
{
    public sealed partial class Services
    {
        ...
        /// Use CreateAccountSummaryObservable().Publish()[.RefCount()] to supoort multiple observers.
        /// Use CreateAccountSummaryObservable().ShareSourceCache(Services.GetAccountSummaryCacheKey)
